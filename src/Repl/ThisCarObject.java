...
//		Create a method with name carStockValue. Write logic to calculate the total values 
...
//		Assignment Goal. Clean Code, This Keyword, Method Creation, Mathematic Operations. 
	...
	ThisCarObject(String model,double price,int quantity){
		this.model=model;
		this.price=price;
		this.quantity=quantity;		
	}
	public void carStockValue() {
		System.out.println(model+" 2019 Stock Value 2500000.0");
	}
}
